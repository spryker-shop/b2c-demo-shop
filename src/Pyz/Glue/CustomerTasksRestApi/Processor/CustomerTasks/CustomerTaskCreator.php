...
class CustomerTaskCreator implements CustomerTaskCreatorInterface
{
    /**
    ...
    public function create(
        ...
        $customerTaskResponseTransfer = $this->customerTasksRestApiClient->create($customerTaskTransfer);
    ...
    private function createCustomerTaskTransfer(
        ...
        $customerTaskTransfer->setFkCreator($customerId);
